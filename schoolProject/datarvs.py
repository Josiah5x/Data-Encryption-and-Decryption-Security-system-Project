...
class Ui_MainWindow(QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.frame_3.setGeometry(QtCore.QRect(0, 60, 1361, 661))
        font = QtGui.QFont()
        ...
        self.comboBox.setGeometry(QtCore.QRect(5, 5, 840, 31))
        self.comboBox.setObjectName("comboBox")
        self.comboBox.setStyleSheet('background: #77a3ca; color: #333' )
        ...
        self.treeView.setGeometry(QtCore.QRect(5, 40, 840, 580))
        ...
        self.treeView.setStyleSheet('QTreeView'
                                    '{ '
                                        'alternate-background-color: #d3e1ee;'
                                        'background: #f8fbfc;'
                                        'color: #333;'
        ...
        self.btn_createkey.setGeometry(65, 20, 30, 30)
        ...
        self.btn_createkey.setToolTip('Create Key for Encryption')
        ...
        self.btn_chatapp.setGeometry(120, 20, 30, 30)
        ...
        self.btn_chatapp.setToolTip('Chat/message Button')
        ...
        self.btn_edit.setGeometry(180, 20, 30, 30)
        ...
        self.btn_edit.setToolTip('Sign/Verify messages using HashFunction Button')
        ...
        self.btn_database.setGeometry(240, 20, 30, 30)
        ...
        self.btn_database.setToolTip('Database Button')
        ...
        self.dd = QtWidgets.QPlainTextDocumentLayout
        ...
        self.label_19.setGeometry(QtCore.QRect(710, 10, 1090, 21))
        ...
        self.label_10.setGeometry(QtCore.QRect(710, 35, 481, 18))
        self.label_10.setStyleSheet("background: none; font-size: 18px; font-weight: bold;  color: #325c81;")
        ...
        self.label.setGeometry(QtCore.QRect(400, 30, 500, 41))
...
class CreateForm(QWidget):
    ...
    def WindowApp(self):
        ...
        self.frame2.setStyleSheet("background: #4681b4;")
        ...
        self.keygenerator.setPlaceholderText('Type key name here')
...
class VerifyHashing(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet(" background: #5d92c0;  font-size: 14px; color: #f4faff; ")
    ...
    def WindowAppVerify(self):
        ...
        self.boardframe.setGeometry(QtCore.QRect(-5, 60, 933, 450))
        ...
        self.boardframe.setStyleSheet("background: #fff;")
        ...
        self.frame1.setStyleSheet("background: #ced6df;")
        ...
        self.frame2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame2.setObjectName("frame")
        self.frame2.setStyleSheet("background: #ced6df;")
        ...
        self.SignInput2.setPlaceholderText('Your signature Key Here')
...
class LogForm(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("background: #4681b4;;")
...
class ChatingApp(QWidget):
    def __init__(self):
        ...
        # self.setWindowModality(Qt.ApplicationModal)
        self.setFixedSize(self.width, self.height)
        self.setStyleSheet("background: #fff; color: #f4faff; border: 1px solid #3477b6")
    ...
    def ChatApp(self):
        ...
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame.setStyleSheet("background: #4681b4;")
        ...
        self.labelComplete = QLabel(self)
        self.labelComplete.setGeometry(200, 180, 71, 16)
        self.labelComplete.setText('Chat Now')
        self.labelComplete.setStyleSheet('color: #5d92c0; border: none')
...
class Encryption_Decrypt_Form(QMainWindow):
    def __init__(self, parent):
        ...
        self.setStyleSheet("background: #fff; color: #eee")
        ...
        self.frame3.setStyleSheet("background: #4681b4;")
        ...
        self.btn_browse.setStyleSheet("background: #00ccbb; color: #005952; border-radius:4px")
...
class DatabaseForm(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("background: #4681b4; color: #4681b4;; border: 1px solid #3477b6;")
