...
class Ui_MainWindow(QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.frame_3.setGeometry(QtCore.QRect(0, 40, 1179, 661))
        font = QtGui.QFont()
        self.frame_3.setFont(font)
        self.frame_3.setFrameShape(QtWidgets.QFrame.Box)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.frame_3.setStyleSheet('background: ghostwhite; color: #333' )
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(850, 40, 320, 100))
        ...
        self.plainTextEdit.setStyleSheet("background-color: #fafbfc;  border: 1px solid #ccc; border-radius: 8px; color: #000;")


        self.plainTextEdit2 = QtWidgets.QPlainTextEdit(self.frame_3)
        self.plainTextEdit2.setGeometry(QtCore.QRect(850, 145, 320, 436))
        ...
        self.plainTextEdit2.setStyleSheet("background-color: #f9f9f9; border: 1px solid #ccc; border-radius: 8px; color: #000;")
        ...
        self.treeView.setGeometry(QtCore.QRect(1, 40, 840, 540))
        ...
        self.treeView.setStyleSheet('QTreeView'
                                    '{ '
                                        ...
                                        '{'
                                        'background: rgba(76, 201, 135, 255);'
                                        'color: #fff;'
                                        '}'
                                            )
        ...
        self.taskbar.setGeometry(QtCore.QRect(0, -5, 1180, 60))
        # self.frame.setFrameShape(QtWidgets.QFrame.Box)
        self.taskbar.setFrameShadow(QtWidgets.QFrame.Raised)
        self.taskbar.setObjectName("taskbar")
        self.taskbar.setStyleSheet("background-color: #760be0; color: #fff;")

        # self.sidebar = QtWidgets.QFrame(self.frame_3)
        # self.sidebar.setGeometry(QtCore.QRect(2, 5, 60, 600))
        # # self.frame.setFrameShape(QtWidgets.QFrame.Box)
        # self.sidebar.setFrameShadow(QtWidgets.QFrame.Raised)
        # self.sidebar.setObjectName("sidebar")                    
        # self.sidebar.setStyleSheet("background-color: #234d80; color: #333;")
        ...
        self.btn_createkey.setGeometry(65, 10, 30, 30)
        ...
        # self.btn_createkey_label.setGeometry(QtCore.QRect(140, 41, 30, 30))
        # self.btn_createkey_label.setStyleSheet(
        #                            "text-align: center;\n"
        #                            "color: #333;")
        # self.btn_createkey_label.setText("Key")


        self.btn_chatapp = QPushButton(self.taskbar)
        # self.btn_chatapp.setGeometry(15, 230, 30, 30)
        self.btn_chatapp.setGeometry(120, 10, 30, 30)
        ...
        # self.btn_chatapp_label.setGeometry(QtCore.QRect(190, 41, 30, 30))
        # self.btn_chatapp_label.setStyleSheet(
        #                            "text-align: center;\n"
        #                            "color: #333;")
        # self.btn_chatapp_label.setText("Chat")
        ...
        self.btn_edit.setGeometry(180, 10, 30, 30)
        ...
        # self.btn_edit_label.setGeometry(QtCore.QRect(235, 41, 30, 30))
        # self.btn_edit_label.setStyleSheet(
        #                            "text-align: center;\n"
        #                            "color: #333;")
        # self.btn_edit_label.setText("HashFunctio")

        self.btn_database = QPushButton(self.taskbar)
        # self.btn_database.setGeometry(15, 340, 30, 30)
        self.btn_database.setGeometry(240, 10, 30, 30)
        ...
        # self.btn_database_label.setGeometry(QtCore.QRect(280, 41, 80, 30))
        ...
        self.label_19.setGeometry(QtCore.QRect(798, 10, 1090, 21))
        ...
        self.label_10.setGeometry(QtCore.QRect(860, 20, 481, 18))
        self.label_10.setStyleSheet("background: none; font-size: 12px; font-weight: bold;  color: #325c81;")
...
class CreateForm(QWidget):
    ...
    def WindowApp(self):
        ...
        self.frame2.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #8614f8, stop:1 #760be0);")
        ...
        self.plainText.setGeometry(10, 170, 341, 81)
        self.plainText.setStyleSheet("background: #fff; border-radius: 2px solid #333; border: none; font-size: 15px; color: #333;")
...
class VerifyHashing(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("background: #760be0; color:#333; ")
        self.setFixedSize(self.width, self.height)
    ...
    def WindowAppVerify(self):
        ...
        self.boardframe.setStyleSheet("background-color: #f9f9f9; color: #333;")

        self.frame1 = QFrame(self.boardframe)
        self.frame1.setGeometry(QtCore.QRect(450, 60, 362, 380))
        self.frame1.setObjectName("frame")
        self.frame1.setStyleSheet("color: #fff; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #8614f8, stop:1 #760be0)")

        self.label_Verify = QtWidgets.QLabel(self)
        self.label_Verify.setGeometry(QtCore.QRect(580, 20, 240, 21))
        ...
        # self.btn_Vsearch2.setStyleSheet("background: qlineargradient(spread:pad, x1:0, y1:0, x2:0.54171, y2:0, stop:0 rgba(35, 160, 80, 255), stop:1 rgba(76, 201, 135, 255)); color: #eee; border-radius: 2px;")
        ...
        # self.btn_Vsearch3.setStyleSheet("background: qlineargradient(spread:pad, x1:0, y1:0, x2:0.54171, y2:0, stop:0 rgba(35, 160, 80, 255), stop:1 rgba(76, 201, 135, 255)); color: #eee; border-radius: 2px;")
        ...
        # self.btn_Verify.setStyleSheet("background: qlineargradient(spread:pad, x1:0, y1:0, x2:0.54171, y2:0, stop:0 rgba(35, 160, 80, 255), stop:1 rgba(76, 201, 135, 255)); color: #eee; border-radius: 2px;")
        ...
        self.frame2.setObjectName("frame")
        self.frame2.setStyleSheet("background: #8614f8; color: #fff;")
        ...
        # self.btn_Ssearch.setStyleSheet("background: qlineargradient(spread:pad, x1:0, y1:0, x2:0.54171, y2:0, stop:0 rgba(35, 160, 80, 255), stop:1 rgba(76, 201, 135, 255)); color: #eee; border-radius: 2px;")
...
class ChatingApp(QWidget):
    def __init__(self):
        ...
        # self.setWindowModality(Qt.ApplicationModal)
        self.setFixedSize(self.width, self.height)
        # self.setStyleSheet("background-color: #eee; color: #f4faff; border: 1px solid #3477b6")
    ...
    def ChatApp(self):
        ...
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame.setStyleSheet("color: #fff; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #8614f8, stop:1 #760be0);")
        ...
        # self.btn_browse_key.setStyleSheet("background: ")


        self.labelComplete = QLabel(self)
        self.labelComplete.setGeometry(200, 160, 71, 16)
        self.labelComplete.setText('Chat Now')
        self.labelComplete.setStyleSheet('color: #fff; border: none')
...
class Encryption_Decrypt_Form(QMainWindow):
    def __init__(self, parent):
        ...
        self.frame3.setStyleSheet("background-color: #1E97E3; color:#fff;")
        ...
        self.btn_browse.setStyleSheet("background: qlineargradient(spread:pad, x1:0, y1:0, x2:0.54171, y2:0, stop:0 rgba(35, 160, 80, 255), stop:1 rgba(76, 201, 135, 255)); color: #eee; border-radius:4px")
        ...
        # self.path_lineEdit.setStyleSheet("background: #fff; border: none; color: #4681b4;")
        ...
        # self.plainText.setStyleSheet("background: #f8fbfc; font-size: 15px; color: #333;")
...
class DatabaseForm(QWidget):
    def __init__(self):
        ...
        self.height =500
        self.DatabaseWindow()
        self.setStyleSheet("background: #1E97E3; color: #eee")
    ...
    def DatabaseWindow(self):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 45, 1230, 1500))
        ...
        self.tableWidget.setStyleSheet("background: #f8fbfc; color: #4681b4;; border: 1px solid #007300; border: none; font-size: 15px;")
