...
class Ui_MainWindow(QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(1180, 670)
        ...
        self.btn_createkey.setToolTip('Click to Encrypt')
        ...
        self.btn_chatapp.setToolTip('Click to Encrypt')
        ...
        self.btn_edit.setToolTip('Click to Encrypt')
        ...
        self.btn_database.setToolTip('Click to Encrypt')
